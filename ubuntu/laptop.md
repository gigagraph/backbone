...
Before proceeding, setup [SSH keys](../system-setup/ssh.md), install the [fonts](../system-setup/fonts.md), and set up the [Firefox Developer Edition browser](../system-setup/firefox/README.md).
