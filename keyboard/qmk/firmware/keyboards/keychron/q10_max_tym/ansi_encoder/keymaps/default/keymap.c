...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //     KC_MUTE,      KC_ESC,              KC_BRID,  KC_BRIU,  RGB_VAD,   RGB_VAI, KC_MCTRL,  KC_LNPAD,  /* \/ */  KC_MPRV,  KC_MPLY,  KC_MNXT,     KC_MUTE,     KC_VOLD,  KC_VOLU,                   KC_INS,   KC_DEL,
    ...
    //     MC_5, /* \ */ KC_LCTL,  KC_LOPTN,            KC_LCMMD, KC_SPC,             MO(MAC_FN),           /* \/ */  KC_SPC,             MO(MAC_L1),  MO(MAC_L2),                     /* / */           KC_LEFT,  KC_DOWN,  KC_RIGHT),
